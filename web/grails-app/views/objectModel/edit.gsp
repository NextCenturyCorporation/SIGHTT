...
<body>
<a href="#edit-objectModel" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-objectModel" class="content scaffold-edit" role="main">
    ...
    <g:form method="post">
        ...
        <g:hiddenField name="version" value="${objectModelInstance?.version}"/>
        <fieldset class="form">
